...
public class Client_DLLString {
    public static void main(String[] args) {
        DoubleLinkedListClass<String> list_1 = new DoubleLinkedListClass<>();
        DoubleLinkedListClass<String> list_2 = new DoubleLinkedListClass<>();
        String item;
        ...
        System.out.println("Inserted in first list the names: John, Ann, Paul, Joshua, Will, Emma, Peter, Linda," +
                           " Joan, David, Miriam, Leah, Jane");
        ...
        System.out.println("First list should be empty. Nothing printed. "); list_1.print();
