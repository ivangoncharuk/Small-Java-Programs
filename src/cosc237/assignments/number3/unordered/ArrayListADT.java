...
public interface ArrayListADT
{
    ...
    public boolean isItemAtEqual(int location, int item); //Method to determine whether item is the same as the item
    // in the list at location.
    ...
    //Method to replace the element in the list at location with repItem.
