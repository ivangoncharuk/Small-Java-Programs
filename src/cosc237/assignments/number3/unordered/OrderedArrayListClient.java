...
public class OrderedArrayListClient {
    public static void main(String[] args)
    {
        ...
        try {
            ...
            OrderedArrayList list1 = new OrderedArrayList(numOfInts1);
            OrderedArrayList list2 = new OrderedArrayList(numOfInts2);
            populate(sf1, list1);
            populate(sf2, list2);
            ...
            OrderedArrayList mergedList = list1.merge(list2);
            mergedList.print();
    ...
    private static void populate(Scanner file, OrderedArrayList list)
    {
        while (file.hasNext()) {
            if (file.hasNextInt())
